<div class="container py-4">
    <form action="{{ route('clientCheckoutSave') }}" method="post">
        ...
        <div class="form-group">
            <label for="phone" class="text-black">No Hp</label>
        ...
        <div class="form-group">
            <label for="note" class="text-black">Catatan</label>
        ...
        <button type="submit" id="pay-button" class="btn text-white float-end" style="background: orange;">Order</button>
    </form>
</div>
@push('js')
    <script>
